  ...
  <ul class="nav secondary-nav language-dropdown">
    <li class="dropdown js-language-dropdown">
      ...
      <div class="js-front-language">
        <form action="https://t.co/JYfxgAPF8m" class="t1-form language" method="POST">
...
>
  ...
  <div class="signin-wrapper" data-login-message="">
    ...
    <form action="https://t.co/JYfxgAPF8m" class="t1-form clearfix signin js-signin" method="POST">
      <fieldset>

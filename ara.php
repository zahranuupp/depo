...
<html lang="tr" data-scribe-reduced-action-queue="true">
  <head>
    ...
    <meta charset="utf-8">
      <script  nonce="dvQQGyVGnpkTPAP7hYOOZg==">
        !function(){window.initErrorstack||(window.initErrorstack=[]),window.onerror=function(r,i,n,o,t){r.indexOf("Script error.")>-1||window.initErrorstack.push({errorMsg:r,url:i,lineNumber:n,column:o,errorObj:t})}}();
      </script>
    
    
  
  <script id="bouncer_terminate_iframe" nonce="dvQQGyVGnpkTPAP7hYOOZg==">
    if (window.top != window) {
  window.top.postMessage({'bouncer': true, 'event': 'complete'}, '*');
}
  </script>
  <script id="ttft_boot_data" nonce="dvQQGyVGnpkTPAP7hYOOZg==">
    window.ttftData={"transaction_id":"00c0bac600bcf881.1d835cb4127ef882\u003c:00b86c9700a17457","server_request_start_time":1550842501002,"user_id":null,"is_ssl":true,"rendered_on_server":true,"is_tfe":true,"client":"macaw-swift","tfe_version":"tsa_f\/1.0.1\/20190206.2140.12b8a68","ttft_browser":"chrome"};!function(){function t(t,n){window.ttftData&&!window.ttftData[t]&&(window.ttftData[t]=n)}function n(){return o?Math.round(w.now()+w.timing.navigationStart):(new Date).getTime()}var w=window.performance,o=w&&w.now;window.ttft||(window.ttft={}),window.ttft.recordMilestone||(window.ttft.recordMilestone=t),window.ttft.now||(window.ttft.now=n)}();
  </script>
  <script id="swift_action_queue" nonce="dvQQGyVGnpkTPAP7hYOOZg==">
  ...
  <script id="composition_state" nonce="dvQQGyVGnpkTPAP7hYOOZg==">
...
data-fouc-class-names="swift-loading"
 dir="ltr">
      <script id="swift_loading_indicator" nonce="dvQQGyVGnpkTPAP7hYOOZg==">
    ...
    <noscript>
      <form action="https://mobile.twitter.com/i/nojs_router?path=%2Flogin" method="POST" class="NoScriptForm">
        <input type="hidden" value="f384da015b2364abbfc208e125c84f56c8392b18" name="authenticity_token">
    ...
    <li class="dropdown js-language-dropdown">
      ...
      <div class="js-front-language">
        <form action="/sessions/change_locale" class="t1-form language" method="POST">
          ...
          <input type="hidden" name="authenticity_token" value="f384da015b2364abbfc208e125c84f56c8392b18">
        </form>
      </div>
    </li>
  </ul>
...
>
  ...
  <iframe aria-hidden="true" class="dm-post-iframe" name="dm-post-iframe"></iframe>
    ...
    <script nonce="dvQQGyVGnpkTPAP7hYOOZg==" id="track-ttft-body-script">
  if(window.ttft){
